...
beautiful.init(gears.filesystem.get_themes_dir() .. "themes/lovelace/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "d", function () awful.spawn(interrobang) end,
              {description = "run interrobang", group = "launcher"}),
